  ...
  <div class="auth-shell">
    ...
    <aside class="brand-panel">
      ...
      <div class="clock-wrap" aria-hidden="true">
        ...
        <div class="slot-card">
          <span class="slot-label">Next appointment</span>
          <span class="slot-time">2:30 PM &middot; Aisha Khan</span>
        </div>
      </div>

      <p class="brand-copy">
        Every booking, every customer, every service — in one calm view.
      </p>
    </aside>
    ...
    <main class="form-panel">
      <div class="form-card">
        ...
        <p class="form-subtitle">Sign in to manage today's schedule.</p>
        ...
        <p class="switch-line">
          ...
          <RouterLink to="/register" class="inline-link strong">Create one</RouterLink>
        </p>
      </div>
    </main>
  </div>
